 ...
 */
class getParagraphRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ParagraphRepository' shared autowired service.
     *
     * @return \App\Repository\ParagraphRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ParagraphRepository.php';

        return $container->privates['App\\Repository\\ParagraphRepository'] = new \App\Repository\ParagraphRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
